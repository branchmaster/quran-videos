...
async function getSubLink (title, page) {
  ...
  for (let i = 0; i < 2; i++) {
    try {
      ...
      await page.waitForFunction('document.querySelectorAll(\'[id="video-title"]\').length > 1')
